...
![1](https://i.loli.net/2019/02/12/5c62e5c14daf9.png ':size=600')
...
![2](https://i.loli.net/2019/02/12/5c62e988d387c.png ':size=600')

待配置文件下载完成后点击右上角的保存，随后将可看到已导入的节点以及分流规则。

进入「运行模式」将其切换为 **自动分流**。

![3](https://i.loli.net/2019/02/12/5c62e74fd6f14.jpeg ':size=200')

再进入「策略」点击 **主页显示** 将其更改为 **自定义策略**。

![4](https://i.loli.net/2019/02/12/5c62e73c1e2b3.jpeg ':size=200')
